...
export const gradientVariants = cva(
  "bg-background transform-gpu bg-size-[16px_16px]",
  {
    variants: {
      axis: {
        ...
        rect: "bg-[linear-gradient(to_right,hsl(var(--lines))_1px,transparent_1px),linear-gradient(to_bottom,hsl(var(--lines))_1px,transparent_1px)]",
        check:
